...
CKEDITOR.config.colorButton_foreStyle={element:"span",styles:{color:"#(color)"},overrides:[{element:"font",attributes:{color:null}}]};CKEDITOR.config.colorButton_backStyle={element:"span",styles:{"background-color":"#(color)"}};CKEDITOR.plugins.add("codeTag",{icons:"code",init:function(a){a.addCommand("wrapCode",{exec:function(a){a.insertHtml("<code>"+a.getSelection().getSelectedText()+"</code>")}});a.ui.addButton("Code",{label:"Wrap code",command:"wrapCode",toolbar:"insert"})}});(function(){function w(){var a=(new Date).getTime();return"xxxyyxxxxyyx".replace(/[xy]/g,function(b){var c=(a+16*Math.random())%16|0;a=Math.floor(a/16);return("x"==b?c:c&7|8).toString(16)})}function x(a){return{exec:function(){CKEDITOR.plugins.cssanim.runHighLightElem(a)}}}function y(a){return{exec:function(b){CKEDITOR.plugins.cssanim.runAddAnimDialog(b,a)}}}function z(a){return{exec:function(b){CKEDITOR.plugins.cssanim.runEditAnimDialog(b,a)}}}function A(a){return{exec:function(){CKEDITOR.plugins.cssanim.runRemoveAnimElem(a)}}}
function B(){var a={};a["highlightsubmenu"+this.tag]=CKEDITOR.TRISTATE_OFF;0>this.elem.$.classList.toString().indexOf("ckAnimClass_")?(a["addanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_OFF,a["editanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_DISABLED,a["removeanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_DISABLED):(a["addanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_DISABLED,a["editanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_OFF,a["removeanimsubmenu"+this.tag]=CKEDITOR.TRISTATE_OFF);return a}var C={BOUNCE:"bounce bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp bounceOut bounceOutDown bounceOutLeft bounceOutRight bounceOutUp".split(" "),
FADE:"fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig fadeOut fadeOutDown fadeOutDownBig fadeOutLeft fadeOutLeftBig fadeOutRight fadeOutRightBig fadeOutUp fadeOutUpBig".split(" "),FLIP:["flip","flipInX","flipInY","flipOutX","flipOutY"],ROTATE:"rotate rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight rotateOut rotateOutDownLeft rotateOutDownRight rotateOutUpLeft rotateOutUpRight rotateRound".split(" "),SLIDE:"slideInDown slideInLeft slideInRight slideInUp slideOutDown slideOutLeft slideOutRight slideOutUp".split(" "),
ZOOM:"zoomIn zoomInDown zoomInLeft zoomInRight zoomInUp zoomOut zoomOutDown zoomOutLeft zoomOutRight zoomOutUp".split(" "),OTHER:"flash hinge jello lightSpeedIn lightSpeedOut pulse rollIn rollOut rubberBand shake swing tada wobble".split(" ")},D="img span button label div figure form h1 h2 h3 h4 h5 h6 p section video table tr td".split(" "),q="";CKEDITOR.plugins.add("cssanim",{lang:"en,fr",icons:"cssanim",requires:"contextmenu",beforeInit:function(){CKEDITOR.document.appendStyleSheet(CKEDITOR.basePath+
"plugins/cssanim/css/cssanim.css");CKEDITOR.document.appendStyleSheet(CKEDITOR.basePath+"plugins/cssanim/css/tabcontent.css")},afterInit:function(a){(a=(a=a.dataProcessor)&&a.htmlFilter)&&a.addRules({elements:{$:function(a){if(a.hasClass("highlight_tag")){a.removeClass("highlight_tag");var c=new CKEDITOR.htmlParser.cssStyle(a.attributes.style);c.rules["background-color"]=a.attributes["data-animation-bg"];c.rules.outline=a.attributes["data-animation-outline"];a.attributes.style=c.toString();delete a.attributes["data-animation-bg"];
delete a.attributes["data-animation-outline"]}}}})},init:function(a){var b=a.lang.cssanim,c=this.path,d=CKEDITOR.tools.extend({acceptedTags:D,acceptedAnimations:C,highlightBGColor:"#87CEFA",highlightBorder:"3px",highlightPadding:"3px"},a.config.cssanim||{},!0);a.config.onLoadAllowedTags=d.acceptedTags.sort();a.config.onLoadAllowedAnimations=d.acceptedAnimations;a.config.allowedTags=a.config.onLoadAllowedTags;a.config.allowedAnimations=a.config.onLoadAllowedAnimations;a.config.highlightBGColor=d.highlightBGColor;
a.config.highlightBorder=d.highlightBorder;a.config.highlightPadding=d.highlightPadding;a.config.customCssFilePath=d.customCssFilePath;d=new CKEDITOR.dialogCommand("cssanimAddAnimDialog");a.addCommand("_myLaunchAddAnimDialog",d);d=new CKEDITOR.dialogCommand("cssanimMainDialog",{allowedContent:"button;span;div{*};*[id,data-animation*](ckAnimClass*)"});a.addCommand("cssanim",d);a.ui.addButton("cssanim",{label:b.genProperties,command:"cssanim",toolbar:"insert"});a.addMenuGroup("highlightGroup",200);
a.contextMenu&&(a.addMenuGroup("cssanimGroup"),a.contextMenu.addListener(function(b){var d=CKEDITOR.plugins.cssanim.getPathToTop(b);var g=!1,m,l,e,p=a.lang.cssanim;if(b&&!b.isReadOnly())for(m=0;m<d.length;m+=1)l=d[m],e=l.getName().toLowerCase(),0<=a.config.allowedTags.indexOf(e)&&(g=!0,e+=m.toString(),a.addCommand("highlightTag"+e,new CKEDITOR.command(a,x(l))),a.addCommand("addAnimTag"+e,new CKEDITOR.command(a,y(l))),a.addCommand("editAnimTag"+e,new CKEDITOR.command(a,z(l))),a.addCommand("removeAnimTag"+
e,new CKEDITOR.command(a,A(l))),l={},l["highlightsubmenu"+e]={label:p.HighLight,group:"highlightGroup",command:"highlightTag"+e,icon:c+"images/lamp.png",order:2},l["addanimsubmenu"+e]={label:p.AddAnimations,group:"highlightGroup",command:"addAnimTag"+e,icon:c+"images/add.png",order:3},l["editanimsubmenu"+e]={label:p.EditAnimations,group:"highlightGroup",command:"editAnimTag"+e,icon:c+"images/edit.png",order:4},l["removeanimsubmenu"+e]={label:p.RemoveAnimations,group:"highlightGroup",command:"removeAnimTag"+
e,icon:c+"images/del.png",order:4},a.addMenuItems&&a.addMenuItems(l));if(!0===g){g={};if(!b||b.isReadOnly())d=null;else{l={};for(p=0;p<d.length;p+=1)b=d[p],m=b.getName().toLowerCase(),e=m.toUpperCase(),0<=a.config.allowedTags.indexOf(m)&&(m+=p.toString(),g["topMenu"+m]=CKEDITOR.TRISTATE_OFF,l["topMenu"+m]={label:e,icon:CKEDITOR.basePath+"plugins/cssanim/icons/cssanim.png",group:"highlightGroup",tag:m,elem:b,order:0,getItems:B});a.addMenuItems(l);d=g}return d}return null}));CKEDITOR.dialog.add("cssanimMainDialog",
this.path+"dialogs/cssanim.min.js");CKEDITOR.dialog.add("cssanimAddAnimDialog",this.path+"dialogs/cssaddanim.min.js");a.on("contentDom",function(){a.document.on("click",function(b){CKEDITOR.plugins.cssanim.cleanHighlight();-1<navigator.userAgent.toLowerCase().indexOf("firefox")&&(b=new CKEDITOR.dom.element(b.data.$.target),a.getSelection().selectElement(b))});CKEDITOR.plugins.cssanim.init(a);CKEDITOR.plugins.cssanim.getCustomCss(a.config.customCssFilePath)});a.on("toHtml",function(b){var c,d,m;for(c in b.data.dataValue.children)b.data.dataValue.children[c].type===
CKEDITOR.NODE_COMMENT&&(0<=b.data.dataValue.children[c].value.indexOf("_ckAnimScript_")||0<=b.data.dataValue.children[c].value.indexOf("_ckAnimCustomCss_"))&&(0<=b.data.dataValue.children[c].value.indexOf("_ckAnimCustomCss_")&&(d=decodeURIComponent(b.data.dataValue.children[c].value.replace(/^\{cke_protected\}/,"")),m=/^.*(customCss\.setAttribute\("href",)(.*)\);customCss(.*)/,d=m.exec(d),null!==d&&(d.index===m.lastIndex&&(m.lastIndex+=1),a.config.customCssFilePath=d[2],a.config.customCssFilePath=
a.config.customCssFilePath.replace(/"/gi,""),a.config.customCssFilePath=a.config.customCssFilePath.trim())),b.data.dataValue.children[c].remove())},null,null,10);a.on("toDataFormat",function(a){CKEDITOR.plugins.cssanim.cleanHighlight();var b;b=CKEDITOR.plugins.get("cssanim").path.replace(/^https?:\/\/[^\/]+/i,"");var c='"',d="",l=!1,e,p=!1,f=CKEDITOR.plugins.cssanim.getAllAnimElem();for(e in f)f[e].css&&(l=!0,c+=f[e].css,c+=f[e].cds,f[e].ral&&(p=!0,d+="document.getElementsByClassName('ckAnimClass_"+
e+"Start')[0].addEventListener('animationend', removeAnimation); ")),f[e].cso&&(l=!0,c+=f[e].cso,c+=f[e].cdo),f[e].csc&&(l=!0,c+=f[e].csc,c+=f[e].cdc);c+='"';if(l||""!==q){e="";f=window.location.href;f=f.replace(f.split("/").pop(),"");p&&(e+="function removeAnimation(event) {var thisId \x3d event.currentTarget.getAttribute('id');",e+="this.classList.remove('ckAnimClass_'+thisId+'Start');",e+="this.removeEventListener('animationend', removeAnimation);",e+="}");var p='var cssStyle \x3d document.createElement("style");',
n="";!1===/^([a-z]+:\/\/|\/\/)/.test(q)&&(q=f+q);l&&(p=p+("cssStyle.innerHTML \x3d "+c+";")+'document.getElementsByTagName("head")[0].appendChild(cssStyle);',n+='var fileref \x3d document.createElement("link");fileref.setAttribute("rel", "stylesheet");',n+='fileref.setAttribute("type", "text/css");',n+='fileref.setAttribute("href", "'+b+'css/cssanim.css");',n+='document.getElementsByTagName("head")[0].appendChild(fileref);');""!==q&&(n+='var customCss \x3d document.createElement("link");',n+='customCss.setAttribute("rel", "stylesheet");',
n+='customCss.setAttribute("type", "text/css");',n+='customCss.setAttribute("href", "'+q+'");',n+='customCss.setAttribute("title", "_ckAnimCustomCss_");',n+='document.getElementsByTagName("head")[0].appendChild(customCss);');b=new CKEDITOR.htmlParser.element("script",{title:"_ckAnimScript_"});b.setHtml("\n(function(){ "+e+p+n+d+"})();");a.data.dataValue.add(b)}},null,null,14)}});CKEDITOR.on("instanceReady",function(a){var b=document.getElementsByTagName("head")[0],c=document.createElement("script");
c.src=CKEDITOR.basePath+"plugins/cssanim/parseCSS3AnimationShorthand.min.js";c.type="text/javascript";b.appendChild(c);a.editor.document.$.addEventListener("contextmenu",function(){CKEDITOR.plugins.cssanim.cleanHighlight()})});CKEDITOR.plugins.cssanim={ckEditor:null,documentEditor:null,curSelectedElement:null,managePending:!1,pendingChanges:[],cssAnimDialog:null,allAvailableAnimsCssAnim:[],allAvailableAnimsCustom:[],allAvailableAnimsConflict:[],init:function(a){this.ckEditor=a;this.documentEditor=
a.document;var b;for(a=document.styleSheets.length-1;0<=a;--a)if(document.styleSheets[a].href&&0<=document.styleSheets[a].href.indexOf("cssanim.css"))for(b=0;b<document.styleSheets[a].cssRules.length;b+=1)document.styleSheets[a].cssRules[b].type===CSSRule.KEYFRAMES_RULE&&this.allAvailableAnimsCssAnim.push(document.styleSheets[a].cssRules[b].name)},setHighLightBgColor:function(a){this.ckEditor.config.highlightBGColor=a},setHighLightBorder:function(a){this.ckEditor.config.highlightBorder=a+"px"},cleanHighlight:function(){var a=
this.documentEditor.$.getElementsByClassName("highlight_tag"),b,c;for(b=0;b<a.length;b+=1)c=a[b],c.classList.remove("highlight_tag"),c.style.backgroundColor=c.getAttribute("data-animation-bg"),c.style.outline=c.getAttribute("data-animation-outline"),c.getAttribute("data-animation-bg"),c.getAttribute("data-animation-outline")},getSurroundElem:function(a,b){return a.getSelection().getStartElement().getAscendant(b,!0)},setCssAnimDialog:function(a){this.cssAnimDialog=a},refreshCssAnimDialogAnimationsTab:function(){this.cssAnimDialog.selectPage("tab-allowed-tags");
this.cssAnimDialog.selectPage("tab-doc-animations")},runHighLightElem:function(a){CKEDITOR.plugins.cssanim.cleanHighlight();a.setAttribute("data-animation-bg",a.getStyle("backgroundColor"));a.setAttribute("data-animation-outline",a.getStyle("outline"));a.setStyle("backgroundColor",this.ckEditor.config.highlightBGColor);a.setStyle("outlineWidth",this.ckEditor.config.highlightBorder);a.setStyle("outlineStyle","solid");a.setStyle("outlineColor","red");a.addClass("highlight_tag")},runHighLightElemById:function(a){CKEDITOR.plugins.cssanim.cleanHighlight();
(a=CKEDITOR.plugins.cssanim.documentEditor.getById(a))&&CKEDITOR.plugins.cssanim.runHighLightElem(a)},getAllAnimElem:function(){var a=this.documentEditor.$.getElementsByClassName("ckAnimClass_"),b={},c,d,h;for(h=0;h<a.length;h+=1)d=a[h],c=d.getAttribute("data-animation"),c=decodeURIComponent(c),c=JSON.parse(c),c.elem=d,b[d.id]=c;return b},runAddAnimDialogById:function(a){if(a=CKEDITOR.plugins.cssanim.documentEditor.getById(a))this.curSelectedElement=a,this.managePending=!0,this.ckEditor.execCommand("_myLaunchAddAnimDialog")},
runAddAnimDialog:function(a,b){CKEDITOR.plugins.cssanim.cleanHighlight();this.curSelectedElement=b;this.managePending=!1;a.execCommand("_myLaunchAddAnimDialog")},runAddAnimElem:function(a,b){var c=b.animStart,d=b.animClick,h=b.animOver,k=b.ral,g;c||d||h?(null===a.getId()&&a.setAttribute("id",w()),a.removeClass("ckAnimClass_"),a.removeClass("ckAnimClass_"+a.getId()),a.removeClass("ckAnimClass_"+a.getId()+"Start"),a.addClass("ckAnimClass_"),a.addClass("ckAnimClass_"+a.getId()),g={},g.id=a.getId(),c&&
(a.addClass("ckAnimClass_"+a.getId()+"Start"),g.css=".ckAnimClass_"+a.getId()+"Start",g.cds="{animation: "+c+";}",g.ral=k),h&&(g.cso=".ckAnimClass_"+a.getId()+":hover",0<=h.indexOf("cssAnimPause")||0<=h.indexOf("animation-play-state")?g.cdo="{animation-play-state: paused;}":g.cdo="{animation: "+h+";}"),d&&(g.csc=".ckAnimClass_"+a.getId()+":active",0<=d.indexOf("cssAnimPause")||0<=d.indexOf("animation-play-state")?g.cdc="{animation-play-state: paused;}":g.cdc="{animation: "+d+";}"),c=encodeURIComponent(JSON.stringify(g)),
a.setAttribute("data-animation",c)):CKEDITOR.plugins.cssanim.runRemoveAnimElem(a)},restoreAnimOnElemById:function(a,b){var c=CKEDITOR.plugins.cssanim.documentEditor.getById(a),d={},h;d.animStart=null;d.animClick=null;d.animOver=null;d.ral=b.ral;b.cds&&(h=b.cds.replace("{animation:","").replace("}","").replace(";","").trim(),d.animStart=h);b.cdo&&(h=b.cdo.replace("{animation:","").replace("}","").replace(";","").trim(),d.animOver=h);b.cdc&&(h=b.cdc.replace("{animation:","").replace("}","").replace(";",
"").trim(),d.animClick=h);CKEDITOR.plugins.cssanim.runAddAnimElem(c,d)},runEditAnimDialog:function(a,b){CKEDITOR.plugins.cssanim.cleanHighlight();this.curSelectedElement=b;a.execCommand("_myLaunchAddAnimDialog")},runRemoveAnimElem:function(a){CKEDITOR.plugins.cssanim.cleanHighlight();var b;for(b=a.$.classList.length-1;0<=b;--b)0<=a.$.classList[b].indexOf("ckAnimClass_")&&a.$.classList.remove(a.$.classList[b]);a.removeAttribute("data-animation")},getPathToTop:function(a){for(var b=[],c=0;a&&"body"!==
a.getName();)void 0===a.$.dataset.ckeRealElementType&&(b[c]=a,c+=1),a=a.getParent();return b},cssanimAddAnimDialogTest:function(a){var b=this.cssanimAddAnimDialog.getElementsByClassName("cke_cssanim_container_div")[0],c,d,h,k,g,m,l,e;"overBtn"===a.name&&(c=this.cssanimAddAnimDialog.querySelector("#cssanimAddAnimDialogTabOver"),d=c.getElementsByTagName("select"),c=c.getElementsByTagName("input"),h=d.namedItem("anim_O").selectedOptions[0].value,k=d.namedItem("timing_O").selectedOptions[0].value,g=d.namedItem("direction_O").selectedOptions[0].value,
m=c.namedItem("duration_O").value+"s",l=c.namedItem("delay_O").value+"s",e=c.namedItem("iteration_O").value,"0"===e&&(e="infinite"),"none"!==h?(b.style.animation="none",setTimeout(function(){b.style.animation=h+" "+m+" "+k+" "+l+" "+e+" "+g},10)):b.style.animation="none");"clickBtn"===a.name&&(c=this.cssanimAddAnimDialog.querySelector("#cssanimAddAnimDialogTabClick"),d=c.getElementsByTagName("select"),c=c.getElementsByTagName("input"),h=d.namedItem("anim_C").selectedOptions[0].value,k=d.namedItem("timing_C").selectedOptions[0].value,
g=d.namedItem("direction_C").selectedOptions[0].value,m=c.namedItem("duration_C").value+"s",l=c.namedItem("delay_C").value+"s",e=c.namedItem("iteration_C").value,"0"===e&&(e="infinite"),"none"!==h?(b.style.animation="none",setTimeout(function(){b.style.animation=h+" "+m+" "+k+" "+l+" "+e+" "+g},10)):b.style.animation="none");"loadBtn"===a.name&&(c=this.cssanimAddAnimDialog.querySelector("#cssanimAddAnimDialogTabLoad"),d=c.getElementsByTagName("select"),c=c.getElementsByTagName("input"),h=d.namedItem("anim_L").selectedOptions[0].value,
k=d.namedItem("timing_L").selectedOptions[0].value,g=d.namedItem("direction_L").selectedOptions[0].value,m=c.namedItem("duration_L").value+"s",l=c.namedItem("delay_L").value+"s",e=c.namedItem("iteration_L").value,"0"===e&&(e="infinite"),"none"!==h?(b.addEventListener("animationend",function(){this.style.animation="none"},!1),b.style.animation="none",setTimeout(function(){b.style.animation=h+" "+m+" "+k+" "+l+" "+e+" "+g},10)):b.style.animation="none")},getAvailableAnims:function(){var a={};a.allAvailableAnimsCssAnim=
this.allAvailableAnimsCssAnim;a.allAvailableAnimsCustom=this.allAvailableAnimsCustom;a.allAvailableAnimsConflict=this.allAvailableAnimsConflict;return a},getCustomCss:function(a){function b(b){CKEDITOR.plugins.cssanim.ckEditor.container.setStyle("pointer-events","");CKEDITOR.plugins.cssanim.ckEditor.document.getBody().setStyle("backgroundColor","");var c=CKEDITOR.plugins.cssanim.ckEditor.lang.cssanim;if(200===b.target.status){var c=h,e=b.target.response;b=a;var g=document.getElementsByTagName("style"),
f;for(f=g.length-1;0<=f;--f)if("cssCustom"===g[f].title){g[f].parentNode.removeChild(g[f]);break}CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM&&delete CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM;CKEDITOR.plugins.cssanim.allAvailableAnimsCustom=[];CKEDITOR.plugins.cssanim.allAvailableAnimsConflict=[];f=document.createElement("style");f.title="cssCustom";f.type="text/css";f.innerHTML=e;document.getElementsByTagName("head")[0].appendChild(f);var n=[],k="",t,
r=null,u=CKEDITOR.plugins.cssanim.ckEditor.lang.cssanim;for(f=document.styleSheets.length-1;0<=f;--f)if(document.styleSheets[f].href&&0<=document.styleSheets[f].href.indexOf("cssanim.css")){r=document.styleSheets[f];break}var v=[];for(f=document.styleSheets.length-1;0<=f;--f)if("cssCustom"===document.styleSheets[f].title)for(e=0;e<document.styleSheets[f].cssRules.length;e+=1)if(document.styleSheets[f].cssRules[e].type===CSSRule.KEYFRAMES_RULE&&0>v.indexOf(document.styleSheets[f].cssRules[e].name)){t=
"\x3cli\x3e"+document.styleSheets[f].cssRules[e].name+"\x3c/li\x3e";n.push(document.styleSheets[f].cssRules[e].name);v.push(document.styleSheets[f].cssRules[e].name);CKEDITOR.plugins.cssanim.allAvailableAnimsCustom.push(document.styleSheets[f].cssRules[e].name);if(r)for(g=0;g<r.cssRules.length;g+=1)if(r.cssRules[g].name===document.styleSheets[f].cssRules[e].name){t='\x3cli\x3e\x3cspan style\x3d"color:tomato"\x3e'+document.styleSheets[f].cssRules[e].name+" "+u.warningOverride+"\x3c/span\x3e\x3c/li\x3e";
CKEDITOR.plugins.cssanim.allAvailableAnimsConflict.push(document.styleSheets[f].cssRules[e].name);break}k+=t}0<k.length?(k='\x3cspan style\x3d"font-weight:bold;"\x3e'+u.animationFound+'\x3c/span\x3e\x3cbr\x3e\x3cul style\x3d"text-align: center; margin:5px; margin-left: 25px;"\x3e'+k+"\x3c/ul\x3e",CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM=n):(k='\x3cspan style\x3d"font-weight:bold; color:red;"\x3e'+u.noAnimationFound+"\x3c/span\x3e\x3cbr\x3e",CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM&&
delete CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM);q=c.trim();CKEDITOR.plugins.cssanim.ckEditor.config.customCssFilePath=c.trim();b&&(d=b.querySelector("#cssResultsDiv"),d.innerHTML=k,d.style.display="block")}else a&&d&&(f='\x3cspan style\x3d"font-weight:bold; color:tomato;"\x3e'+c.errorLoadingFile+b.target.responseURL+"\x3c/span\x3e",f+='\x3cbr\x3e\x3cspan style\x3d"font-weight:bold; color:red;"\x3e'+c.loadStatus+b.target.status+"\x3c/span\x3e\x3cbr\x3e",d.innerHTML=f,d.style.display=
"block"),alert(c.specFile+b.target.responseURL+c.fileNotAvailable)}function c(){alert(CKEDITOR.plugins.cssanim.ckEditor.lang.cssanim.fileCannotAccess);CKEDITOR.plugins.cssanim.ckEditor.container.setStyle("pointer-events","");CKEDITOR.plugins.cssanim.ckEditor.container.setStyle("outline","")}var d,h;"[object String]"===Object.prototype.toString.apply(a)?(h=a.trim(),a=null):(d=a.querySelector("#cssResultsDiv"),d.innerHTML="",d.style.display="none",h=d.parentElement.elements.cssName.value.trim());var k=
h.substr(h.lastIndexOf(".")+1);if(!(h===this.ckEditor.config.customCssFilePath&&0<this.allAvailableAnimsCustom.length))if(h)"css"!==k?alert(lang.fileSpecified+h+lang.fileExtInvalid):(this.ckEditor.container.setStyle("pointer-events","none"),this.documentEditor.getBody().setStyle("backgroundColor","Gainsboro "),k=new XMLHttpRequest,k.onload=b,k.onerror=c,k.open("GET",h,!0),k.send());else{var k=document.getElementsByTagName("style"),g;for(g=k.length-1;0<=g;--g)if("cssCustom"===k[g].title){k[g].parentNode.removeChild(k[g]);
break}CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM&&delete CKEDITOR.plugins.cssanim.ckEditor.config.allowedAnimations.CUSTOM;q="";this.ckEditor.config.customCssFilePath="";CKEDITOR.plugins.cssanim.allAvailableAnimsCustom=[];CKEDITOR.plugins.cssanim.allAvailableAnimsConflict=[]}}}})();CKEDITOR.plugins.add("devtools",{init:function(k){k._.showDialogDefinitionTooltips=1},onLoad:function(){CKEDITOR.document.appendStyleText(CKEDITOR.config.devtools_styles||"#cke_tooltip { padding: 5px; border: 2px solid #333; background: #ffffff }#cke_tooltip h2 { font-size: 1.1em; border-bottom: 1px solid; margin: 0; padding: 1px; }#cke_tooltip ul { padding: 0pt; list-style-type: none; }")}});
...
function(d){var c=d.editor;if(c._.showDialogDefinitionTooltips){a||(a=CKEDITOR.dom.element.createFromHtml('\x3cdiv id\x3d"cke_tooltip" tabindex\x3d"-1" style\x3d"position: absolute"\x3e\x3c/div\x3e',CKEDITOR.document),a.hide(),a.on("mouseover",function(){this.show()}),a.on("mouseout",function(){this.hide()}),a.appendTo(CKEDITOR.document.getBody()));var b=d.data.definition.dialog,f=c.config.devtools_textCallback||k;b.on("load",function(){for(var d=b.parts.tabs.getChildren(),g,e=0,h=d.count();e<h;e++)g=
d.getItem(e),g.on("mouseover",function(){var a=this.$.id;m(f,this,c,b,null,a.substring(4,a.lastIndexOf("_")))}),g.on("mouseout",function(){a.hide()});b.foreach(function(d){if(!(d.type in{hbox:1,vbox:1})){var e=d.getElement();e&&(e.on("mouseover",function(){m(f,this,c,b,d,b._.currentTabId)}),e.on("mouseout",function(){a.hide()}))}})})}})})();CKEDITOR.config.plugins='dialogui,dialog,about,a11yhelp,basicstyles,blockquote,clipboard,panel,floatpanel,menu,contextmenu,resize,button,toolbar,elementspath,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,wysiwygarea,image,indent,indentlist,fakeobjects,link,list,magicline,maximize,pastetext,pastefromword,removeformat,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc,panelbutton,colorbutton,codeTag,cssanim,devtools';CKEDITOR.config.skin='moono';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('about,0,51px,bold,59,51px,italic,118,51px,strike,177,51px,subscript,236,51px,superscript,295,51px,underline,354,51px,blockquote,413,51px,copy-rtl,472,51px,copy,531,51px,cut-rtl,590,51px,cut,649,51px,paste-rtl,708,51px,paste,767,51px,horizontalrule,826,51px,image,885,51px,indent-rtl,944,51px,indent,1003,51px,outdent-rtl,1062,51px,outdent,1121,51px,anchor-rtl,1180,51px,anchor,1239,51px,link,1298,51px,unlink,1357,51px,bulletedlist-rtl,1416,51px,bulletedlist,1475,51px,numberedlist-rtl,1534,51px,numberedlist,1593,51px,maximize,1652,51px,pastetext-rtl,1711,51px,pastetext,1770,51px,pastefromword-rtl,1829,51px,pastefromword,1888,51px,removeformat,1947,51px,source-rtl,2006,51px,source,2065,51px,specialchar,2124,51px,scayt,2183,51px,table,2242,51px,redo-rtl,2301,51px,redo,2360,51px,undo-rtl,2419,51px,undo,2478,51px,spellchecker,2537,51px,bgcolor,2596,51px,textcolor,2655,51px,code,5428,auto,cssanim,5546,auto','icons_hidpi.png');else setIcons('about,0,auto,bold,110,auto,italic,220,auto,strike,330,auto,subscript,440,auto,superscript,550,auto,underline,660,auto,blockquote,770,auto,copy-rtl,880,auto,copy,990,auto,cut-rtl,1100,auto,cut,1210,auto,paste-rtl,1320,auto,paste,1430,auto,horizontalrule,1540,auto,image,1650,auto,indent-rtl,1760,auto,indent,1870,auto,outdent-rtl,1980,auto,outdent,2090,auto,anchor-rtl,2200,auto,anchor,2310,auto,link,2420,auto,unlink,2530,auto,bulletedlist-rtl,2640,auto,bulletedlist,2750,auto,numberedlist-rtl,2860,auto,numberedlist,2970,auto,maximize,3080,auto,pastetext-rtl,3190,auto,pastetext,3300,auto,pastefromword-rtl,3410,auto,pastefromword,3520,auto,removeformat,3630,auto,source-rtl,3740,auto,source,3850,auto,specialchar,3960,auto,scayt,4070,auto,table,4180,auto,redo-rtl,4290,auto,redo,4400,auto,undo-rtl,4510,auto,undo,4620,auto,spellchecker,4730,auto,bgcolor,4840,auto,textcolor,4950,auto,code,5060,auto,cssanim,5170,auto','icons.png');})();CKEDITOR.lang.languages={"en":1};}());